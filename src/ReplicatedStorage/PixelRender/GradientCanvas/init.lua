...
This is a modified version of Greedy/GradientCanvas by BoatBomber. 
This version has the ability to remove blur artefacts from the original module and slightly improve performance. 
There also some other minor additions.
	...
	function Canvas:Render()
		for x, column in pairs(self._UpdatedColumns) do
			...
			for y, color in ipairs(column) do
				...
				if not BlurEnabled then -- Full pixels (least performant), or full blur (most performant)
